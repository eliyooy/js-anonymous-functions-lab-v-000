...
function play() {
  $('#play').on('click', handleClickPlaySong);
}

function handleClickPlaySong(e) {
  $('#songPlaying').html("now playing " + songToPlay + " by " + theArtist);
  return "now playing " + songToPlay + " by " + theArtist;
}

function pause() {
  $('#pause').on('click', handleClickPause);
}
...
function show() {
  $('#show').on('click', handleClickShowSongs);
}

function handleClickShowSongs(e) {
  var songs = "";
